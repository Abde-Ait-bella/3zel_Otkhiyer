            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="px-4 container-fluid">
                        ...
                        <div class="mb-4 card"><div class="card-body">When scrolling, the navigation stays at the top of the page. This is the end of the static navigation demo.</div></div>
                    </div>
                </main>
